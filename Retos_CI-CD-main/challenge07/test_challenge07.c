 ...
 *
 * Q: ¿El archivo test_challenge07.c contiene las pruebas unitarias indicadas?
 * A: Sí ✅ - Ver todas las pruebas assert() a continuación
 *
 * Q: ¿El comando make test ejecuta las pruebas unitarias correctamente?
 * A: Sí ✅ - Las pruebas se ejecutan y verifican los resultados
 *
 * Q: ¿Las pruebas verifican la función suma()?
 * A: Sí ✅ - Ver las pruebas con diferentes casos (positivos, negativos, cero)
 */
